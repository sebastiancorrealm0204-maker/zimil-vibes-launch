...
function Index() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col" style={{ backgroundColor: "#0D0D18" }}>
      ...
      <main className="flex-1">
        ...
        <section id="waitlist" style={{ backgroundColor: "#08080E" }} className="py-24 px-5 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-white/30 mb-3">Únete</p>
          <h2 className="font-display text-3xl font-bold text-white mb-4 sm:text-4xl">
          ...
          <button
            ...
            className="inline-block rounded-full px-8 py-3.5 text-base font-semibold text-white transition-opacity hover:opacity-85"
